...
# -*- coding: utf-8 -*-
#
# Parser for Old OCR Output format
# https://azure.microsoft.com/en-us/blog/azure-media-ocr-simplified-output/
# In order to get Old OCR Output format from AMS OCR MP, the following minimal preset needed
# {
#   'Version':'1.0', 
#   'Options': {
#     'AdvancedOutput':'true'
